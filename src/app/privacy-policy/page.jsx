            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
                    ...
                    <div className="space-y-6">
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">Overview</h3>
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">What This Privacy Policy Covers</h3>
                            <p className="text-gray-700">
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">Membership Eligibility</h3>
                            <p className="text-gray-700">
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">Information Collection and Use</h3>
                            <p className="text-gray-700">
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">Information Sharing and Disclosure</h3>
                            <p className="text-gray-700">RealMotorJapan does not rent, sell, or share personal information about
                            ...
                            <ul className="list-disc pl-6 mt-2 text-gray-700 space-y-1">
                                <li>- We provide the information to trusted partners who work with
                                    RealMotorJapan under confidentiality agreements.</li>
                                <li>- We respond to subpoenas, court orders, or legal process, or to
                                    establish or exercise our legal rights or defend against legal claims.</li>
                                <li>- We believe it is necessary to share information in order to
                            ...
                            <p className="text-gray-700"> RealMotorJapan uses information for the following general purposes: to
                                fulfill your requests for services, improve our services, contact you,
                                conduct research, and provide anonymous reporting for internal and
                                external clients.</p>
                        </section>
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">Cookies</h3>
                            <p className="text-gray-700">RealMotorJapan may set and access RealMotorJapan cookies on your
                                computer.</p>
                            <p className="text-gray-700">We use data collection devices called "cookies" on certain pages of the
                                ...
                                "cookie".</p>
                            <p className="text-gray-700">We also use cookies to allow you to enter your password less frequently
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">Your Right to Edit and Delete Your Personal Information</h3>
                            <p className="text-gray-700">
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">Confidentiality and Security</h3>
                            <p className="text-gray-700">
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">Changes or Revision to this Privacy Policy</h3>
                            <p className="text-gray-700">
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">Questions and Suggestions</h3>
                            <p className="text-gray-700">
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-blue-700 mb-3">Criteo's Service</h3>
                            <p className="text-gray-700">
                            ...
                            <p className="text-gray-700">
                            To learn more or opt out of Criteo services, please click here:{"Criteo Privacy Policy"}
                            </p>
