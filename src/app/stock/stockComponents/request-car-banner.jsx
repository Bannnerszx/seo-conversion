...
export default function RequestCarBanner() {
    return (
        <div className="rounded-xl border-2 border-[#0000ff] p-4 sm:p-6 m-4">
            ...
            <Link
                href="/request-form"
                className="inline-flex h-12 w-full md:w-auto items-center justify-center rounded-md bg-[#0000ff] px-4 text-md font-semibold text-white hover:opacity-90 text-center"
            >
