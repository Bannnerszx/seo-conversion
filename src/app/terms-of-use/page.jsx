    ...
    <div className="min-h-screen mt-20">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
          <h2 className="text-2xl font-bold text-blue-800 mb-6">Terms of Use</h2>

          <div className="space-y-6">
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3"> Article 1 (Scope of these Regulations)</h3>
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3"> Article 2 (Provision of the Service)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3"> Article 3 (Consideration for the Service)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 4 (User Registration and Authentication)</h3>
              <p className="text-gray-700">
                ...
                connection with any product or service without the prior written consent of our company.
              </p>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 5 (Contact Information)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 6 (Handling User Information)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 7 (Intellectual Property Rights)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 8 (Transactions and Communication with Other Operators)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 9 (Links and Advertisements)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 10 (RealMotorJapan's Obligations and Liability)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 11 (Prohibited Acts)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 12 (Termination of Use)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 13 (Damages)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Article 14 (Entire Agreement and Severability)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3"> Article 15 (Target Regions, Governing Law, and Jurisdiction)</h3>
              <p className="text-gray-700">
