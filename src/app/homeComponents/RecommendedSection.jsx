...
const RecommendedSection = ({ newVehicles, currency }) => {
    ...
    return (
        <div className='bg-black'>
            <div className="flex items-center gap-4 px-6 py-4">
                {/* Line */}
                <div className="h-[2px] bg-[#fff] flex-1 max-w-[70px] ml-[-25]" />

                {/* Text */}
                <h1 className="text-base text-[30px] font-bold text-[#fff] whitespace-nowrap font ">Recommended</h1>
                                ...
                                return (
                                    ...
                                    >
                                        <Link key={car.id} href={`/product/${car.id}`}>
                                            <div className="bg-black rounded-2xl shadow-md overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg h-full">
                                                <div className="relative h-auto">
                                                    ...
                                                    <div className="absolute top-4 right-4">
                                                        <div className="bg-gradient-to-r from-red-600 via-orange-500 to-yellow-400 text-white font-bold px-3 py-1 rounded-full text-sm">
                                                            HOT
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="p-5">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <span className="text-lg font-semibold whitespace-nowrap overflow-hidden text-ellipsis block max-w-full text-white">{car.carName}</span>
