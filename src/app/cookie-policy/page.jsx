...
export async function generateMetadata({ params }) {
  return {
    title: 'Cookie Policy | REAL MOTOR JAPAN',
    description: 'Cookies are small pieces of text sent to your web browser by a website you visit. A cookie file is stored in your web browser and allows the Service or a third-party to recognize you and make your next visit easier and the Service more useful to you.',
  }
};
    ...
    <div className="min-h-screen mt-20">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
          <h2 className="text-2xl font-bold text-blue-800 mb-6">Cookie Policy</h2>

          <div className="space-y-6">
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Terms of Member's ID Agreement</h3>
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">1. Person Who Registers with the Website</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">2. ID and Password</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">3. Account Settings Information</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">4. Delete Account (Withdrawal)</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">5. Damage for Delay, Interruption, and Discontinuance of Internet</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">6. Individual Information Registered</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">7. Regulations concerning the Use of Membership</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">8. De-registration and Stoppage of Member's ID</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">9. Prohibition</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">10. Validity of this Agreement on User Whose Registration is Cancelled</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">11. Indemnity</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">12. Discharge</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">13. End of Service</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">14. Dispute Settlement</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">15. Copyright and Trademark</h3>
              <p className="text-gray-700">
            ...
            <section>
              <h3 className="text-xl font-semibold text-blue-700 mb-3">16. Governing Law, Jurisdiction and Revision</h3>
              <p className="text-gray-700">
